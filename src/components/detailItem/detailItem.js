    ...
    <div className="relative flex pt-16 items-center smt:flex-col mdt:flex-col  xlt:flex-col">
      ...
      <div className="w-1/4 smt:w-screen px-5 mdt:w-full xlt:w-full">
        <div>
          ...
          <span className="text-base ">Thương Hiệu : Beanpole</span>
        ...
        <div className="mt-20">
          ...
          <p>
            ...
            Kiểu dáng: đầm thiết kế dáng chữ A dài qua gối, tone màu hồng in họa
            tiết hoa hồng, cổ xẻ đính ngọc
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="">
      ...
      {product?.size.map((size) => (
        <Button
          ...
          style={
            typeBtn === size
              ? { backgroundColor: "#6d3f0a", color: "white" }
              : null
          }
        >
