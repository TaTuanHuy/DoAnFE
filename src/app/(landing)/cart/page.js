...
import {
  ...
  increasing,
  decrease,
} from "@/redux/features/counter/orderSlice";
  ...
  return (
    <div className="md:container min-h-[1000px] smt:px-5 ">
      <h1 className="py-6 text-[14px] uppercase">
        <Link href={"/"}>TRANG CHỦ</Link> / Giỏ Hàng Của Bạn - Beanpole
      </h1>
              ...
              >
                ...
                <td className="px-6 py-4">
                  <p className="flex space-x-3">
                    <Minus
                      onClick={() =>
                        changeNumber("decrease", item.product, item.quantity)
                      }
                    />{" "}
                    <span className="text-blue-700">{item.amount}</span>{" "}
                    <Plus
                      onClick={() =>
                        changeNumber("increasing", item.product, item.quantity)
                      }
                    />
                  </p>
                </td>
